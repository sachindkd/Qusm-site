...
export default async function HomePage() {
  ...
  return (
    <main className="site-shell">
      ...
      <ScrollReveal><section id="about" className="statement-section section-pad">
      ...
      <ScrollReveal delay={0.05}><section id="command" className="command-section section-pad">
      ...
      <ScrollReveal><section id="news" className="news-section section-pad"><div className="section-label">/ 03 — Signal</div><div className="section-heading-row"><h2>What&apos;s <span>happening.</span></h2><Sparkles size={22} className="heading-icon" /></div>
      ...
      <ScrollReveal><section className="media-section section-pad"><div className="section-label">/ Visual archive</div><div className="media-intro"><h2>Inside<br /><em>QUSM.</em></h2><p>Selected moments, systems and visual records.</p></div>
      ...
      <ScrollReveal><section className="cta-section section-pad"><div className="cta-glow" /><div className="cta-ring" /><div className="section-label">/ End transmission</div><h2>Keep the<br /><span>mission moving.</span></h2><p>Stay close to the command structure, latest updates and everything QUSM.</p><a href="/login" className="button button-primary">Enter staff portal <ArrowUpRight size={16} /></a></section></ScrollReveal>
